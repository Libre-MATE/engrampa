...
#define EGG_FILE_FORMAT_CHOOSER(obj)                             \
  (G_TYPE_CHECK_INSTANCE_CAST(obj, EGG_TYPE_FILE_FORMAT_CHOOSER, \
                              EggFileFormatChooser))
#define EGG_FILE_FORMAT_CHOOSER_CLASS(klass)                    \
  (G_TYPE_CHECK_CLASS_CAST(klass, EGG_TYPE_FILE_FORMAT_CHOOSER, \
                           EggFileFormatChooserClass))
#define EGG_IS_FILE_FORMAT_CHOOSER(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE(obj, EGG_TYPE_FILE_FORMAT_CHOOSER))
#define EGG_IS_FILE_FORMAT_CHOOSER_CLASS(obj) \
  (G_TYPE_CHECK_CLASS_TYPE(obj, EGG_TYPE_FILE_FORMAT_CHOOSER))
#define EGG_FILE_FORMAT_CHOOSER_GET_CLASS(obj)                    \
  (G_TYPE_INSTANCE_GET_CLASS((obj), EGG_TYPE_FILE_FORMAT_CHOOSER, \
                             EggFileFormatChooserClass))
