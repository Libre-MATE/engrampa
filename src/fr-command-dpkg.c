...
static void process_metadata_line(char *line, FrCommand *comm) {
  FileData *fdata;
  char **fields;
  char *name;
...
static void process_data_line(char *line, gpointer data) {
  FileData *fdata;
...
static void fr_command_dpkg_list(FrCommand *comm) {
...
static void fr_command_dpkg_extract(FrCommand *comm, const char *from_file,
...
static const char **fr_command_dpkg_get_mime_types(FrCommand *comm) {
  return dpkg_mime_type;
}

static FrCommandCaps fr_command_dpkg_get_capabilities(FrCommand *comm,
...
static const char *fr_command_dpkg_get_packages(FrCommand *comm,
                                                const char *mime_type) {
...
static void fr_command_dpkg_init(FrCommand *comm) {
...
GType fr_command_dpkg_get_type() {
  static GType type = 0;

  if (!type) {
    GTypeInfo type_info = {sizeof(FrCommandDpkgClass),
                           NULL,
                           NULL,
    ...
    type =
        g_type_register_static(FR_TYPE_COMMAND, "FRCommandDpkg", &type_info, 0);
  }
